const PoolBuilderSelectors = {
    ...
    Verify_State1: 'div:nth-child(2) > label > span.hashtag-container.ng-star-inserted > span:nth-child(1)',
    Verify_State2: 'div:nth-child(2) > label > span.hashtag-container.ng-star-inserted > span:nth-child(2)',
    Verify_Status: 'div:nth-child(3) > label > span.hashtag-container.ng-star-inserted > span',
    Verify_Age: 'div > draftdetails-patient-pool-criteria:nth-child(13) > div > div:nth-child(5) > label > span.detail',
    Verify_Study: 'div > div > div:nth-child(18) > label > span.detail',
