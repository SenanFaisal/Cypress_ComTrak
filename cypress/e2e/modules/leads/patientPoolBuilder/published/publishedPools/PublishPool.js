...
class PublishPatientPool {
    CreateAndPublishPatientPool() {
      ...
      cy.origin('https://comtrak.qa.dmclinical.com/',
        ...
        ({DRP_Leads, TXT_PoolName, Pool_Name, BTN_Create, TXT_Description, Description, BTN_Continue1, MIN_AgeSlider, MAX_AgeSlider, BTN_Continue2, DRP_IntendedStudy, IntendedStudy, Verify_Name, Verify_Description, Verify_State1, Verify_State2, Verify_Status, Verify_Age, Verify_Study, BTN_Cross, BTN_CreatePool, EYE_ReviewPool}
        ) => {
          cy.wait(5000)
